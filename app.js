...
const myProfileRouter = require(path.join(__dirname+"/routes/myProfile.route.js"));
app.use("/myProfile", myProfileRouter);

const transactionRouter = require(path.join(__dirname+"/routes/transaction.route.js"));
